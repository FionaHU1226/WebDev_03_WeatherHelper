<template>
    <header class="sticky top-0 bg-weather-primary shadow-lg">
        <nav class="container flec flex-col sm:flex-row items-center gap-4 text-white py-6">
            ...
            <BaseModal :modal-active="modalActive" @close-modal="toggleModal">
                <div class="text-black">
                    <h1 class="test-2xl mb-1">About:</h1>
                    <p class="mb-4">
                    ...
                    <p class="mb-4">
                        If yuo no longer with to track a city, simply select the city within the home page. At the bottom of the page, there will be an option to delete the city.
                    </p>
                </div>
            </BaseModal>
        </nav>
